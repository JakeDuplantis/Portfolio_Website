...
//create close the contact form when the user click off of it
...
function showSlides(n) {
    ...
    for (i = 0; i < dots.length; i++) {
        dots[i].className = dots[i].className.replace(" active", ""); // this for loop takes each item in the array "dots" and removes "active" which remoces the active styling
    }
    slides[slideIndex - 1].style.display = "block"; //thsi display the image in the slideshow
